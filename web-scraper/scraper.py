...
#TODO: Automate proxy choice. Potentially another program to scrape
#      values off of free-proxy-list, or a similar domain.
import argparse
import json
import itertools
import logging
...
def get_soup(url, header):
    ...
    #request_data.set_proxy("181.129.67.50:54158", "http")
